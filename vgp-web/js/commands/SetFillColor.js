 ...
 */
var SetFillColorCommand = function(commandString) {
    this.commandString = commandString;
};

SetFillColorCommand.prototype.execute = function(context) {
    var reResults = this.commandString.match(this.REGEXP);

    var color = reResults[1];

    if (this.colors[color.toLowerCase()] != undefined) {
        context.setFillColor(this.colors[color.toLowerCase()]);
    }
...
SetFillColorCommand.prototype.colors = {
    "aliceblue": "#F0F8FF",
    "antiquewhite": "#FAEBD7",
    "aqua": "#00FFFF",
    "aquamarine": "#7FFFD4",
